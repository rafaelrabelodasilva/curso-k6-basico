...
export const options = { //Aqui estamos internalizando os argumentos do script k6, essa constante obrigatóriamente precisa ter o nome de "options"
  stages: [ //teste de carga que irá definir os estágios
    {duration: '1m', target: 100}, //Aqui o k6 terá 1minuto para colocar 100 usuários simultâneos durante a execução
